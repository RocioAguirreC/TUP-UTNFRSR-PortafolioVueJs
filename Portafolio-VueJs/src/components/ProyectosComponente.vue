...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Optimizing Online Sales through Data-Driven Insights (E-commerce) (2024)",
        descripcion: "Analyze historical sales data to identify trends, seasonal patterns, and customer behavior.Develop test cases to ensure the accuracy and reliability of the sales data and reporting systems.",
    ...
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Customer Satisfaction Survey Analysis (2023)",
        descripcion: "Analyze customer satisfaction survey data to identify areas of strength and weakness in customer experience. Develop action plans to address customer pain points, improve customer service, and increase customer loyalty.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Website Performance Optimization (2022)",
        descripcion: "Conduct performance testing to identify and fix performance bottlenecks.Implement strategies to optimize website code, images, and server configuration to improve website speed and user experience.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Employee Performance Analysis (2021)",
        descripcion: "Implement performance improvement plans, provide targeted training, and offer incentives to motivate employees and increase overall organizational performance.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
])
