...
const experiencias = ref([
    ...
    { id: 3, src: icono3, parrafo: 'Writing Bug Reports and reviews.'},
    { id: 4, src: icono4, parrafo: 'Communicate and respond on time to any request from the Test Team Leads or Test Engineers.'},
    { id: 5, src: icono5, parrafo: 'Utilized strong written communication skills to compose, edit, and proofread various types of documents, ensuring accurate and professional communication with internal and external stakeholders.'},
]);
</script>
