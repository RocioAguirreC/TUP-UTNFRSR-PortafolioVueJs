...
const educacion = ref([
  {fecha: '2024', title: 'Pursuing a University Technical Degree in Programming at UTN-FRSR', descripcion: 'Data Processing Analysis and Development: developed well-structured programs for computer solutions.Programming and Debugging', enlace:''},
  {fecha: '2023', title: 'International English Language Testing System (IELTS)', descripcion: 'General Training. Overall Band Score 6.5. CEFR Level B2 (British Council).', enlace:''},
  {fecha: '2023', title: 'Introduction to Power BI (Datapath)', descripcion: 'foundational knowledge in Power BI, including data visualization, report creation, and dashboard building.', enlace:'http:www.direccion.com'},
  {fecha: '2023', title: 'Postman API Fundamentals Student Expert (Postman)', descripcion: 'API fundamentals using Postman, covering API requests, responses, and endpoints.', enlace:'http:www.direccion.com'},
  {fecha: '2023', title: 'Software Testing & QA (Qarmy)', descripcion: 'foundational knowledge in software testing and quality assurance, including test planning, case design, and defect tracking.', enlace:'http:www.direccion.com'},
  {fecha: '2022', title: 'Introduction to Cybersecurity (Cisco)', descripcion: 'foundational knowledge in cybersecurity principles, including threat analysis, risk management, and best practices for securing systems and data.', enlace:'http:www.direccion.com'},
  {fecha: '2022', title: 'Software Testing from cero: Masterclass all-in-one (Udemy)', descripcion: 'Acquired skills in QA methodologies and tools to support high standards in software development and delivery.', enlace:'http:www.direccion.com'},
  {fecha: '2021', title: 'Scrum Fundamentals Certified (ScrumStudy)', descripcion: 'Completed certification in Scrum fundamentals, covering core principles of Agile methodology, Scrum roles, events, and artifacts.', enlace:'http:www.direccion.com'},
  {fecha: '2021', title: 'Web Design (Python, Django & SQL)', descripcion: 'Proficient in crafting dynamic and user-friendly web applications using the powerful Python programming language.uccessfully developed chacu.py using Django, incorporating features such as user authentication and data visualization.', enlace:'http:www.direccion.com'},
  {fecha: '2020', title: 'Introduction to Programming', descripcion: 'Fundamental understanding of programming concepts, including variables, data types, control flow, and functions. Proficient in problem-solving and algorithmic thinking', enlace:'http:www.direccion.com'},
  {fecha: '2019', title: 'Technical Degree in Business Administration.', descripcion: 'Proficient in data analysis and interpretation to support strategic planning and problem-solving. Comprehensive understanding of business principles and practices, including finance, marketing, operations, and human resources.', enlace:'http:www.direccion.com'}
]);
</script>
